...
<p style="color: yellow; font-size: 10">2. Real-time API</span></p>
...
<p style="color: yellow; font-size: 10">3. 미세 조정(Fine-tuning)</p>
...
<p style="color: yellow; font-size: 10">4. 그외 업데이트</p>   
